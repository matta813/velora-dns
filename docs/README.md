...
This documentation describes the development foundation. Unimplemented features are
explicitly listed in the roadmap, rather than represented by placeholder endpoints.
